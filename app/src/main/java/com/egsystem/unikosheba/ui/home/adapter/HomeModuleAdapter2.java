...
import com.egsystem.unikosheba.ui.services.ServicesActivity;
...
public class HomeModuleAdapter2 extends RecyclerView.Adapter<HomeModuleAdapter2.HomeModuleViewHolder> {
    ...
    List<String> home_module_id_list = new ArrayList<>();
    Context context;
    ...
    public HomeModuleAdapter2(Context context) {
...
//        }
    ...
    public void setData(List<String> home_module_name_eng_list, List<String> home_module_image_list, List<String> home_module_id_list) {
...
//        this.home_module_name_ban_list = home_module_name_ban_list;
        ...
        this.home_module_id_list = home_module_id_list;
    }

    public void filterList(List<String> home_module_name_eng_list, List<String> home_module_image_list, List<String> home_module_id_list) {
        this.home_module_name_eng_list = home_module_name_eng_list;
//        this.home_module_name_ban_list = home_module_name_ban_list;
        this.home_module_image_list = home_module_image_list;
        this.home_module_id_list = home_module_id_list;
    ...
    public HomeModuleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_item_home_module_list2, parent, false);
...
//        String title_ban = home_module_name_ban_list.get(position);
        ...
        String itemId = home_module_id_list.get(position);
