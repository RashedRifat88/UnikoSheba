...
public class ServicesForSearchAdapter extends RecyclerView.Adapter<ServicesForSearchAdapter.ViewHolder>{
    ...
    OnServiceClick listener;



    public ServicesForSearchAdapter(Context context, List<Services> list, OnServiceClick listener){
...
//        this.cart = ShoppingCartHelper.getCart();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        ...
        View v= LayoutInflater.from(context)
                .inflate(R.layout.item_service_for_search,parent,false);
