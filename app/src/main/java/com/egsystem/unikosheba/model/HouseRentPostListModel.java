...
public class HouseRentPostListModel implements Serializable {
    ...
    public class HouseRentPost implements Serializable {
    ...
    public class Result implements Serializable {
        ...
        @SerializedName("house_rent_posts")
        @Expose
        private List<HouseRentPost> houseRentPosts;

        public List<HouseRentPost> getHouseRentPosts() {
            return houseRentPosts;
        }

        public void setHouseRentPosts(List<HouseRentPost> houseRentPosts) {
            this.houseRentPosts = houseRentPosts;
        }
