...
public class TutorRequestListModel {
    ...
    public class Result {
        ...
        @SerializedName("tutor_request_posts")
        @Expose
        private List<TutorRequestPost> tutorRequestPosts;

        public List<TutorRequestPost> getTutorRequestPosts() {
            return tutorRequestPosts;
        }

        public void setTutorRequestPosts(List<TutorRequestPost> tutorRequestPosts) {
            this.tutorRequestPosts = tutorRequestPosts;
        }

    }


    public class TutorRequestPost {
