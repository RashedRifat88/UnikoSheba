...
public class NursePackagePurchaseHistoryModel {
    ...
    public class NursePackagePurchase {
        ...
        public void setNursePackageServices(List<Object> nursePackageServices) {
    ...
    public class Result {
        ...
        public List<NursePackagePurchase> getNursePackagePurchases() {
            return nursePackagePurchases;
        }

        public void setNursePackagePurchases(List<NursePackagePurchase> nursePackagePurchases) {
            this.nursePackagePurchases = nursePackagePurchases;
        }
